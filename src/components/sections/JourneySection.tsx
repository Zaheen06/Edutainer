...
const journeyOptions = [
  {
    ...
    image: "/images/journey/journey-1.jpg",
    icon: GraduationCap,
  ...
  },
  {
    title: "For Students",
    contactLabel: "Contact Us",
    image: "/images/journey/journey-2.jpg",
    icon: Users,
  ...
  },
  {
    ...
    contactLabel: "Contact Us",
    image: "/images/journey/journey-3.jpg",
    icon: Briefcase,
    ...
    <section className="py-20 md:py-24 bg-white">
      <div className="container-custom">
        ...
        >
          <SectionHeader
            badge="Get Started"
            title="Start Your Journey with Edutainer"
            description="Whether you're a student, university, or looking for career opportunities, we have the perfect path for you"
            className="mb-14"
          />
        </motion.div>
